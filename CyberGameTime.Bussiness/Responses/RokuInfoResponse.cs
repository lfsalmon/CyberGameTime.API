...
namespace CyberGameTime.Bussiness.Responses
{
    ...
    public class RokuInfoResponse
    {
        ...
        public bool MobileHasLiveTv { get; set; }
        ...
        [XmlElement(ElementName = "lightning-base-build-number")]
        public string LightningBaseBuildNumber { get; set; }

        [XmlElement(ElementName = "ui-build-number")]
        public string UiBuildNumber { get; set; }

        [XmlElement(ElementName = "ui-software-version")]
        public string UiSoftwareVersion { get; set; }

        [XmlElement(ElementName = "ui-software-build")]
        public int UiSoftwareBuild { get; set; }
        ...
        public bool HasHandsFreeVoiceRemote { get; set; }
        ...
        [XmlElement(ElementName = "device-automation-bridge-enabled")]
        public bool DeviceAutomationBridgeEnabled { get; set; }
        ...
        public bool SupportsTrc { get; set; }
        ...
        public string AvSyncCalibrationEnabled { get; set; }


        public AddScreanQuery CreateRequest(string _ipAddress)=>new AddScreanQuery()
        {
            IpAddres = _ipAddress,
            Name = ModelName,
            Roku_DeviceId = DeviceId,
            Roku_SerialNumber = SerialNumber,
            Roku_udn= Udn
        };
    }
}
